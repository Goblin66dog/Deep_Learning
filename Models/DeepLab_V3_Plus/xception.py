...
class Xception(nn.Module):
    ...
    """
    def __init__(self, downsample_factor,inchannels= 3):
        """ Constructor
        Args:
        ...
        self.conv1 = nn.Conv2d(inchannels, 32, 3, 2, 1, bias=False)
...
def xception(pretrained=True, downsample_factor=16,in_channels = 3):
    model = Xception(downsample_factor=downsample_factor,inchannels = in_channels)
    if pretrained:
        pretrained_dict = torch.load(r"D:\Github_Repo\Deep_Learning\Models\DeepLab_V3_Plus\xception_pytorch_imagenet.pth")
