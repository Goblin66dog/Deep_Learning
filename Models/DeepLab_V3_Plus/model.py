...
class DeepLab(nn.Module):
    def __init__(self, num_classes, backbone="mobilenet", pretrained=True, downsample_factor=16,in_channels=3):
        ...
        if backbone=="xception":
            ...
            #   主干部分    [30,30,320]
            #----------------------------------#
            self.backbone = MobileNetV2(downsample_factor=downsample_factor, pretrained=pretrained,in_channels=in_channels)
            ASPP_in_channels = 320
        ...
        #   利用不同膨胀率的膨胀卷积进行特征提取
        #-----------------------------------------#
        self.aspp = ASPP(dim_in=ASPP_in_channels, dim_out=256, rate=16//downsample_factor)
